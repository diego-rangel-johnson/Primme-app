...
import { Eye, Grid3X3, Palette, Compass, ArrowUpRight, Zap } from "lucide-react";
...
const ACTIONS = [
  {
    ...
    description: "Upload a photo and test premium paint colors in real time.",
    href: "/client/inspiration/visualizer",
  },
  {
    icon: Grid3X3,
    title: "Create Moodboard",
    description: "Drag and drop images, colors, and notes onto a freeform canvas.",
    href: "/client/inspiration/boards",
  },
  {
    icon: Palette,
    title: "Browse Colors",
    description: "Explore 200+ colors from Sherwin-Williams, Benjamin Moore, and more.",
    href: "/client/inspiration/palettes",
  },
  {
    icon: Compass,
    title: "Explore Ideas",
    description: "Curated rooms, finishes, and textures to spark your vision.",
